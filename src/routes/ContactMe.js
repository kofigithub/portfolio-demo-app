...
const ContactUs = () => {
 ...
 <i class='fa fa-envelope' aria-hidden='true'style={{color : 'gray'}}></i> kofiowusutufuor@gmail.com<br />
 <i class='fa fa-github' aria-hidden='true'style={{color : 'gray'}}><a href='https://www.github.com/kofigithub'> https://www.github.com/kofigithub</a></i></div><br />
  </div>)
};
